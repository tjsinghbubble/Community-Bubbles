...
const categoryTree: ParentCategory[] = [
  {
    ...
    children: [
      { name: "hiking", displayName: "Hiking", icon: "walk", placeholderName: "e.g., Trail Blazers", placeholderTagline: "e.g., Explore trails and make friends", placeholderDescription: "e.g., Weekend hikes, trail recommendations, and outdoor adventures for nature lovers of every skill level." },
      { name: "running", displayName: "Running", icon: "walk", placeholderName: "e.g., Morning Mile Crew", placeholderTagline: "e.g., Lace up and hit the road together", placeholderDescription: "e.g., A group for runners of all levels who want to train, share routes, and stay motivated together." },
      { name: "cycling", displayName: "Cycling", icon: "bicycle", placeholderName: "e.g., Pedal Pals", placeholderTagline: "e.g., Ride together, go further", placeholderDescription: "e.g., Group rides, route sharing, and bike maintenance tips for cyclists in the neighborhood." },
      { name: "yoga", displayName: "Yoga", icon: "body", placeholderName: "e.g., Flow Together", placeholderTagline: "e.g., Stretch, breathe, and find your balance", placeholderDescription: "e.g., Group yoga sessions, pose tutorials, and mindfulness practices for yogis of all levels." },
      { name: "fitness_classes", displayName: "Fitness Classes", icon: "barbell", placeholderName: "e.g., FitFam Local", placeholderTagline: "e.g., Sweat it out together", placeholderDescription: "e.g., Join group fitness classes, bootcamps, and workout sessions with neighbors who love staying active." },
      { name: "dance", displayName: "Dance", icon: "musical-notes", placeholderName: "e.g., Rhythm & Moves", placeholderTagline: "e.g., Dance like nobody's watching", placeholderDescription: "e.g., Salsa, hip-hop, ballroom or freestyle — find your groove with fellow dance lovers nearby." },
      { name: "pickleball", displayName: "Pickleball", icon: "tennisball", placeholderName: "e.g., Pickle Posse", placeholderTagline: "e.g., Dink, drive, and have fun", placeholderDescription: "e.g., Casual and competitive pickleball games for players of all levels in your area." },
      { name: "team_sports", displayName: "Team Sports", icon: "football", placeholderName: "e.g., Weekend Warriors", placeholderTagline: "e.g., Play together, win together", placeholderDescription: "e.g., Organize pickup games, leagues, and scrimmages for basketball, soccer, volleyball and more." },
      { name: "tennis", displayName: "Tennis", icon: "tennisball", placeholderName: "e.g., Local Racket Club", placeholderTagline: "e.g., Find your doubles partner", placeholderDescription: "e.g., Casual rallies, friendly matches, and skill-building sessions for tennis enthusiasts nearby." },
    ],
  },
  {
    name: "creative", displayName: "Creative", icon: "color-palette",
    children: [
      { name: "cooking", displayName: "Cooking", icon: "restaurant", placeholderName: "e.g., Home Chef Collective", placeholderTagline: "e.g., Cook, share, and savor together", placeholderDescription: "e.g., Swap recipes, host cook-alongs, and explore cuisines from around the world with fellow foodies." },
      { name: "arts_and_crafts", displayName: "Arts and Crafts", icon: "brush", placeholderName: "e.g., Creative Corner", placeholderTagline: "e.g., Make something beautiful together", placeholderDescription: "e.g., Share your creations, join craft nights, and learn new techniques with fellow artists and makers." },
      { name: "photography", displayName: "Photography", icon: "camera", placeholderName: "e.g., Shutter Squad", placeholderTagline: "e.g., Capture the moment together", placeholderDescription: "e.g., Photo walks, editing tips, and portfolio sharing for photographers at every level." },
      { name: "music", displayName: "Music", icon: "musical-notes", placeholderName: "e.g., Jam Session Crew", placeholderTagline: "e.g., Make music, make friends", placeholderDescription: "e.g., Jam sessions, open mics, and music appreciation meetups for musicians and music lovers." },
      ...
      { name: "board_games", displayName: "Board Games", icon: "game-controller", placeholderName: "e.g., Game Night Gang", placeholderTagline: "e.g., Roll the dice and have fun", placeholderDescription: "e.g., Regular game nights with board games, card games, and tabletop RPGs for all experience levels." },
    ],
  },
  {
    name: "food_and_social", displayName: "Food & Social", icon: "cafe",
    children: [
      { name: "coffee_meetups", displayName: "Coffee Meetups", icon: "cafe", placeholderName: "e.g., Morning Brew Club", placeholderTagline: "e.g., Connecting over great coffee", placeholderDescription: "e.g., Casual meetups at local cafés to chat, network, and discover the best brews in town." },
      { name: "dining_out", displayName: "Dining Out", icon: "restaurant", placeholderName: "e.g., Flavor Explorers", placeholderTagline: "e.g., Taste the best spots in town", placeholderDescription: "e.g., Restaurant reviews, food crawls, and tasting events for anyone who loves discovering new flavors." },
  ...
  },
  {
    ...
    children: [
      { name: "dog_pet_groups", displayName: "Dog/Pet Groups", icon: "paw", placeholderName: "e.g., Paws & Friends", placeholderTagline: "e.g., Playdates for pets and their humans", placeholderDescription: "e.g., Connect with local pet owners for walks, playdates, pet-sitting swaps, and adorable photo shares." },
      ...
      { name: "wellness", displayName: "Wellness", icon: "medkit", placeholderName: "e.g., Mindful Living Circle", placeholderTagline: "e.g., Nurture your mind, body, and soul", placeholderDescription: "e.g., Meditation sessions, wellness challenges, and self-care tips to help you feel your best." },
      { name: "gardening", displayName: "Gardening", icon: "leaf", placeholderName: "e.g., Green Thumb Gang", placeholderTagline: "e.g., Grow together, bloom together", placeholderDescription: "e.g., Tips, plant swaps, and garden tours for anyone who loves getting their hands in the dirt." },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { name: "neighborhood_groups", displayName: "Neighborhood Groups", icon: "home", placeholderName: "e.g., Neighborhood Circle", placeholderTagline: "e.g., Bringing neighbors closer together", placeholderDescription: "e.g., A hub for local events, safety updates, recommendations, and getting to know the people around you." },
    ],
  },
  {
    ...
    children: [
      ...
      { name: "professional_networking", displayName: "Professional Networking", icon: "briefcase", placeholderName: "e.g., Career Connect Hub", placeholderTagline: "e.g., Grow your network, grow your career", placeholderDescription: "e.g., A space for professionals to share advice, find mentors, and explore new opportunities together." },
