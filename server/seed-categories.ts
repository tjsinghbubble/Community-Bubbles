...
const categoryTree: ParentCategory[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "book_clubs", displayName: "Book Clubs", icon: "book", image: "/images/categories/book_clubs.jpg", placeholderName: "e.g., Page Turners", placeholderTagline: "e.g., Read, discuss, repeat", placeholderDescription: "e.g., Monthly book picks, lively discussions, and literary adventures with fellow readers nearby." },
  ...
  },
  {
    ...
    children: [
      ...
      { name: "wine_and_spirits", displayName: "Wine and Spirits", icon: "wine", image: "/images/categories/wine_and_spirits.jpg", placeholderName: "e.g., Pour & Savor", placeholderTagline: "e.g., Sip, swirl, and socialize", placeholderDescription: "e.g., Wine tastings, brewery tours, and cocktail nights for enthusiasts of fine beverages." },
